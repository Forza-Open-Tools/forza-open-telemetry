...
declare namespace CanvasGauges {
    ...
    export type GaugeEventListener = () => void;
    export type EventListeners = Record<CanvasGaugeEvent, GaugeEventListener>;
    ...
    export abstract class BaseGauge {
        ...
        public on(event: CanvasGaugeEvent, listener: GaugeEventListener): void;
